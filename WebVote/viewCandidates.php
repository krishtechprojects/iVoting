...
<head>
  ...
  <title>i-Voting - View Candidates</title>
          ...
          <?php
            ...
            if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td>" . $row['adharid'] . "</td>";
                echo "<td>" . $row['name'] . "</td>";
                echo "<td>" . $row['phone'] . "</td>";
                echo "<td>" . $row['party'] . "</td>";
                echo "<td>" . $row['constituency'] . "</td>";
                echo "<td><img src='symbols/" . $row['symbol'] . "' width='50' height='50' alt='Symbol'></td>";
                echo "<td><img src='photos/" . $row['photo'] . "' width='50' height='50' alt='Photo'></td>";
                echo "<td><a href='DeleteCandidate.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm'>Delete</a></td>";
                echo "</tr>";
              }
            } else {
